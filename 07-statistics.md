...
>> Frequentists do not attempt to work with prior probabilities, nor do they use probabilities for a hypothesis. They view that there is a true hypothesis with fixed parameters.
>>
>> Bayesians use probabilities for hypotheses and data. They utilize Bayes' theorem by implementing a known prior probability of the data or constructing one. The ultimate goal is to determine the probability of a hypothesis given the data.  
